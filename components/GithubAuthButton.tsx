...
export function GithubAuthButton() {
  ...
  if (status === "loading") {
    return <div className="h-9 rounded-xl" />;
  }
  ...
  return (
    <div className="flex items-center gap-2 rounded-2xl border border-nimbus-border bg-nimbus-surface px-3 py-2 shadow-[var(--nimbus-shadow)]">
      {session.user.image ? (
      ...
      <span className="flex-1 truncate text-sm text-nimbus-text">
