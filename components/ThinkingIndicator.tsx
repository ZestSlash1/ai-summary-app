export function ThinkingIndicator() {
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex items-center gap-2.5 self-start rounded-[var(--nimbus-radius-card)] rounded-bl-lg border border-nimbus-border bg-nimbus-surface px-4 py-3 shadow-[var(--nimbus-shadow)]"
    >
      ...
      <span className="nimbus-thinking-label text-sm font-medium">
        Thinking
      </span>
    </div>
  );
